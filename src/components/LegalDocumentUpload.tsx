...
const LegalDocumentUpload: React.FC = () => {
  ...
  const analyzeDocuments = () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      toast.success('Legal documents analyzed successfully');
      navigate('/analysis');
    }, 2000);
  };
    ...
    <div className="w-full max-w-4xl mx-auto py-8">
      ...
      >
        <div className="text-center">
          ...
          <h3 className="text-lg font-medium mb-2">Drag & drop your legal documents here</h3>
          ...
          <input
            ...
            accept=".pdf,.doc,.docx"
          />
          <label htmlFor="legal-file-upload">
